...
struct CalendarIntervalTests {
    ...
    func hourFactories() {
        ...
        let moreThanDay: CalendarInterval = .hours(25)
    ...
    func negativeTimeFactories() {
        ...
        #expect(minusOneHour.day == 0)
        #expect(minusOneHour.nanosecond == -NanoSeconds.perHour64)
    }
}
...
extension CalendarIntervalTests {
    ...
    func unaryMinus() {
        ...
        #expect(negative.day == -1) // -1 day from nanosecond normalization
        #expect(negative.nanosecond == -100)
    }
}
